...
const Header = () => {
  ...
  return (
    <header className="fixed x-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      {/* Destop tablet */}
        ...
        <div className="flex items-centers gap-8">
          ...
          <div className="relative">
            <motion.img
              ...
              className="w-10 min-w-[40px] h10 min-h-[40px] drop-shadow-xl cursor-pointer rounded-full"
              alt="userprofile"
              onClick={login}
            />
            {isMenu && (
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base bg-gray-200"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
