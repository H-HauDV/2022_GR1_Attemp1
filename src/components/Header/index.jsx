        ...
        <div className="hidden md:flex w-full h-full items-center justify-between">
          ...
          <div className="flex items-centers gap-8">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute -top-0 -right-1 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center">
            ...
            <img src={Avatar} className="w-10 min-w-[40px] h10 min-h-[40px] drop-shadow-xl" alt="userprofile" />
          </div>
        </div>
      {/* Mobile */} 
